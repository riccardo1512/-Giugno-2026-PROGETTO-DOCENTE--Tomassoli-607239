...
insert into player (id, name, surname, date_of_birth, role, height, team_id)
values(nextval('player_seq'), 'Paolo', 'Rossi', '1990-09-23', 'Forward', 182, (select id from team where name = 'Juventus'));
insert into player (id, name, surname, date_of_birth, role, height, team_id)
values(nextval('player_seq'), 'Marco', 'Bianchi', '1995-02-12', 'Midfielder', 178, (select id from team where name = 'Roma'));
insert into player (id, name, surname, date_of_birth, role, height, team_id)
values(nextval('player_seq'), 'Luca', 'Verdi', '1998-07-04', 'Defender', 185, (select id from team where name = 'Inter'));
insert into player (id, name, surname, date_of_birth, role, height, team_id)
values(nextval('player_seq'), 'Andrea', 'Neri', '1992-11-15', 'Goalkeeper', 191, (select id from team where name = 'Milan'));
insert into player (id, name, surname, date_of_birth, role, height, team_id)
values(nextval('player_seq'), 'Davide', 'Conti', '1996-05-08', 'Forward', 180, (select id from team where name = 'Lazio'));
insert into player (id, name, surname, date_of_birth, role, height, team_id)
values(nextval('player_seq'), 'Giorgio', 'Serra', '1993-01-30', 'Defender', 187, (select id from team where name = 'Roma'));
...
values(nextval('tournament_seq'), 'Serie A', 2025, 'Campionato nazionale di massima serie.');
insert into tournament (id, name, year, description)
...
values(nextval('credentials_seq'), 'admin', '$2a$10$yWAIDyuEr78BBBFZ5cYh8.Nw4gUHFTRG5FwaWqNCGeOD8M4mh3.xy', 'ADMIN',
	(select id from users where username = 'admin'));
insert into credentials (id, username, password, role, user_id)
values(nextval('credentials_seq'), 'mario', '$2a$10$yWAIDyuEr78BBBFZ5cYh8.Nw4gUHFTRG5FwaWqNCGeOD8M4mh3.xy', 'DEFAULT',
	(select id from users where username = 'mario'));
insert into credentials (id, username, password, role, user_id)
values(nextval('credentials_seq'), 'luigi', '$2a$10$yWAIDyuEr78BBBFZ5cYh8.Nw4gUHFTRG5FwaWqNCGeOD8M4mh3.xy', 'DEFAULT',
	(select id from users where username = 'luigi'));